...
public final class ReportHtmlRenderer {
    ...
    public static String render(ReportDocument document) {
        ...
        builder.append("<h2>Live study summary</h2><ul>")
        ...
        builder.append("<p>Live data versus active snapshot: ").append(document.liveFreshness()).append("</p>");
        var quality = document.qualitySummary();
        builder.append("<h2>Current quality summary</h2><ul>")
        ...
        if (document.approvedFindings().isEmpty()) {
            ...
            for (var finding : document.approvedFindings()) {
                ...
                builder.append("<p class=\"muted\">").append(escape(document.findingProvenance().get(finding.id()))).append("</p>");
