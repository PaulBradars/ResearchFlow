...
public final class VersionService {
    ...
    public VersionService(VersionRepository repository, StudyWriteGuard writeGuard) {
        this.writeGuard = java.util.Objects.requireNonNull(writeGuard);
        this.repository = repository;
    }

    public researchflow.domain.DatasetFreshness freshness(UUID studyId) { return repository.freshness(studyId); }
