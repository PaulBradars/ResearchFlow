...
public final class ReportWorkspaceView {
    ...
    private void showPreview(ReportDocument document) {
        ...
        preview.getChildren().add(sectionLabel("Live study summary"));
        ...
        preview.getChildren().add(wrapped("Live data versus active snapshot: " + document.liveFreshness()));
        var quality = document.qualitySummary();
        preview.getChildren().add(sectionLabel("Current quality summary"));
        ...
        if (document.approvedFindings().isEmpty()) {
            ...
            for (var finding : document.approvedFindings()) {
                ...
                box.getChildren().add(muted(document.findingProvenance().get(finding.id())));
